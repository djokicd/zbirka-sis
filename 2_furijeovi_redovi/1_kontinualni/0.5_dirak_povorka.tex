\PID \label{z:dirak_povorka} \mnImportant
...
задатку \refz{rect_povorka}, има се 
\begin{eqnarray}
...
(б) У случају када се развој ради на умношку основног периода, тада ће под интегралом остати више Диракових импулса. 
