...
Заменом ову кондензатора $i_{\rm C} = C \dfrac{\de v_C}{\de t}$, интеграљењем
...
\begin{eqnarray}
    ...
    \label{eq:\ID_i2s}
\end{eqnarray}
Добијени резултати за стурје се растављају на парцијалне разломке у односу на променљиву 
...
изражавањем збира односо разлике косинуса преко производа.
\footnote{ Одговарајући тригонометријски идентитеи јесу
...
су приказани одговарајући сигнали. Испрекиданим линијама приказане су енвелопе тих сигнала, 
