...
\begin{equation}
    ...
    \right)
\end{equation}
% Пошто су сопствена учестаност система и учестаност побуде блиски, може се писати $\upomega = \upomega_0 + \Delta \upomega$, па се 
% заменом налази 
% \begin{eqnarray}
%     \uptheta(t) &=& \dfrac{2 H_0 V_{\rm g}}{\uppi}
%     \dfrac{1}{\underbrace{(\upomega_0 - \upomega)}_{\Delta\upomega}\underbrace{(\upomega_0 + \upomega)}_{\approx 2\upomega_0} }
%     \left(
%         \sin(\upomega_0 t ) \cos(\Delta\upomega t) + \cos(\upomega_0 t )\sin(\Delta\upomega t)
%         - \dfrac{\upomega}{\upomega_0} \ee^{-\upsigma t} \sin(\upomega_0 t ) 
%     \right) \\
%     &=& \dfrac{H_0 V_{\rm g}}{\uppi \upomega \Delta \upomega}
%     \left(
%         \left(
%             \cos(\Delta\upomega t) - \ee^{-\upsigma t}
%         \right)\sin(\upomega_0 t )
%     \right)
% \end{eqnarray}