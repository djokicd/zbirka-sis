...
На основу резултата задатка \refz{rect_povorka} је комплексни спектар разматраног сигнала
...
\end{eqnarray}
Одавде се коначно, на основу резултата задатка \refz{damp_sin} има 
\begin{equation}
...
Ради бољег квалитативног описа добијеног резултата, по узору на поступак из задатка \refz{LC_izbijanje}, усвојићемо  
