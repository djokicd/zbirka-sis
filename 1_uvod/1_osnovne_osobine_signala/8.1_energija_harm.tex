...
типа\footnote{
    ...
    ортогонални за $m \neq n$ у смислу дефинисаном у задатку \refz{zbirP}a. Овај став је од 
...
Резултат се може добити и уопштењем става из задатка \refzz{zbirP}. Будући да су сабирци израза у задатку облика 
