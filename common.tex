...
\usepackage[b5paper, textwidth = 415 pt, textheight = 600 pt, marginparwidth = 10 mm]{geometry}
...
\newcommand{\mnImportant}{\marginpar{$\clubsuit$}}
\newcommand{\mnAst}{\marginpar{$\bigstar$}}
\newcommand{\mnAdvanced}{\marginpar{\noway}}
