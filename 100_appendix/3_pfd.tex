...
за $p_i$ различите реалне вредности, онда се сваки кофицијент $A_k$ може израчунати „прикривањем“ (односно уклањањем) члана $s - p_k$ из израза, 
...
\begin{center}
    ...
    $$
        ...
        \bigl(s-(\upsigma - \jj\upomega)\bigr)\cdots}
