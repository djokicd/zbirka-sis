...
Нека су $x(t)$ и $y(t)$ сигнали ограничени у времену на опсег $-T/2 < t < T$, где је $T$ заједнички период оба сигнала. 
...
За дискретни сигнал $x[n]$ (и $y[n]$), за који постоји Фуријеова трансформација
