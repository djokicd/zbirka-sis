...
\begin{center}
    ...
    \hline
    \redTablice \label{T:ctft:delta} & $\updelta(t)$ & $1$ \\
    \hline
    ...
    \hline
    \redTablice \label{T:ctft:exp} & $\mathrm{e}^{-at} \, \mathrm{u}(t), \quad \Re a > 0$ & $\dfrac{1}{a + \jj\upomega}$ \\
    \hline
...
\begin{center}
    ...
    \begin{tabu}{|c|c|c|} 
    \hline
    рбр & $x[n]$ & Период $X(\jj\Omega) = \FT{x[n]}$, $|\Omega| < \uppi$ \\
    \hline \hline
    %(1) 
    \redTablice &
    $\updelta[n]$ & $1$ \\
    ...
    \redTablice &
    $
    \sum\limits_{p=-\infty}^{+\infty} \updelta[n-p\, N]$ & 
    $
    {\frac{2\uppi}{N}} 
    \sum_{k =-\infty}^{\infty}
    \updelta\left(\Omega - \dfrac{2k\uppi}{N}\right)$ \\
    \hline
    %(5)
...
\begin{center}
    ...
    \hline \hline
    \redTablice \label{T:ZT:delta} & $\delta[n]$ & $1$ \\
    \hline
    \redTablice \label{T:z:exp} & $a^n \, \mathrm{u}[n]$ & $\dfrac{z}{z-a}$ \\
    \hline
